package com.aj.lld.behavioralpatterns.observer.weatherstation.observable;

import java.util.ArrayList;
import java.util.List;

import com.aj.lld.behavioralpatterns.observer.weatherstation.observer.WeatherObserver;
